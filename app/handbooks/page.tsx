...
export const metadata: Metadata = {
  ...
  description: 'Explore beginner-friendly visual handbooks for LangChain, Docker, GitHub Copilot and Forward Deployed Engineering with practical workflows and scenarios.',
  alternates: { canonical: '/handbooks/' },
  openGraph: {title:'Visual Technology Handbooks | MaanavaN Bytes',description:'Connected, beginner-friendly handbooks for LangChain, Docker, GitHub Copilot and Forward Deployed Engineering.',url:'/handbooks/',type:'website'},
};
