...
export const metadata: Metadata = {
  ...
  description: 'Learn LangChain, Docker, GitHub Copilot and Forward Deployed Engineering through beginner-friendly visual Bytes, practical workflows and interview insights.',
