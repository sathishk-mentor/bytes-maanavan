...
function handbookVisual(slug: string) {
  ...
  if (slug === 'python-genai-agentic-ai') return { Icon: Code2, tone: 'copilot' };
...
function HandbookScene({ slug }: { slug: string }) {
  ...
  if (slug === 'python-genai-agentic-ai') return <svg {...common}><path d="M38 32h76v45H38zM50 46h23M50 58h42"/><path d="M126 54h38m-8-8 8 8-8 8"/><circle cx="195" cy="54" r="23"/><path d="M184 54h22M195 43v22M219 54h45m-8-8 8 8-8 8"/></svg>;
