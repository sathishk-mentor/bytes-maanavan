...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-main container-custom">
      ...
      <section><h3>Explore Handbooks</h3><Link href="/handbooks/">All Handbooks</Link><Link href="/handbooks/generative-ai/">Generative AI</Link><Link href="/handbooks/ai-agents/">AI Agents</Link><Link href="/forward-deployed-engineer/">FDE Handbook</Link><Link href="/handbooks/claude-code/">Claude Code</Link></section>
