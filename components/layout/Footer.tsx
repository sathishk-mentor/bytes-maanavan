...
export function Footer() {
  return <footer className="site-footer">
    <div className="footer-main container-custom">
      ...
      <section><h3>Learn with Bytes</h3><Link href="/genai/">Generative AI</Link><Link href="/ai-agents/">AI Agents</Link><Link href="/data-engineering/">Data Engineering</Link><Link href="/cloud-devops/">Cloud & DevOps</Link><Link href="/software-engineering/">Software Engineering</Link><Link href="/cybersecurity/">Cybersecurity</Link></section>
