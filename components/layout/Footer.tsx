...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-main container-custom">
      <section className="footer-brand"><p className="footer-logo">MaanavaN<sup>®</sup></p><span>AI UPSKILLS · BYTES</span><p>Visual, practical technology learning for Tamil-speaking learners worldwide—from one clear concept to confident application.</p><a className="footer-membership" href={membership}>Explore All-Access Membership <ArrowRight/></a><div><a href="tel:+918073044127"><Phone/>+91 8073044127</a><a href="mailto:info@maanavan.com"><Mail/>info@maanavan.com</a></div></section>
      <section><h3>Learn with Bytes</h3><Link href="/software-engineering/">GitHub Copilot Handbook</Link><Link href="/software-engineering/62-how-developers-use-ai-tools/">Copilot foundations</Link><Link href="/software-engineering/66-ai-assisted-coding-workflow/">AI-assisted workflow</Link><Link href="/software-engineering/75-secure-ai-coding/">Responsible AI coding</Link></section>
