...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-main container-custom">
      ...
      <section><h3>Explore Handbooks</h3><Link href="/handbooks/">Browse all Bytes</Link><Link href="/software-engineering/">GitHub Copilot Handbook</Link><Link href="/forward-deployed-engineer/">FDE Handbook</Link><Link href="/cloud-devops/">Docker Handbook</Link></section>
