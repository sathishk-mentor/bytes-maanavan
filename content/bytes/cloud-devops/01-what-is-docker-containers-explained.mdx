...
These examples answer one question: **where does a repeatable application package remove confusion?** Follow each card from the original setup problem to the visible result.
