...
<KnowledgeCheck question={"What should happen before building a customer solution?"} options={["Start coding immediately","Confirm the problem, users, constraints and success evidence","Choose the largest architecture"]} answer={1} explanation={"Discovery prevents teams from solving the wrong problem and defines how value will be measured."} />

## References and further reading

- [Agile Manifesto: Principles behind the Manifesto](https://agilemanifesto.org/principles.html)
- [Google Cloud Architecture Framework](https://cloud.google.com/architecture/framework)
- [DORA: Capabilities for software delivery performance](https://dora.dev/capabilities/)
