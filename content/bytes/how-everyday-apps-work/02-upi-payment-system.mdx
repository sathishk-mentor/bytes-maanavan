...
<KnowledgeCheck question="A payment request times out after the bank may have processed it. What should the app do first?" options={["Retry immediately", "Verify the authoritative transaction state", "Always mark it failed"]} answer={1} explanation="The app must verify and reconcile the transaction state before retrying, otherwise it may create a duplicate payment." />
