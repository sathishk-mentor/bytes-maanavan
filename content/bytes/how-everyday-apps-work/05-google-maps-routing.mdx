...
<KnowledgeCheck question="Why does Maps combine historical traffic patterns with live conditions?" options={["Either source alone can miss important context", "To avoid calculating alternative routes", "Only to shorten the visual map"]} answer={0} explanation="Historical patterns show what usually happens, while live signals reveal today’s unexpected conditions." />
