...
summary: "Transform MongoDB events into summaries, rankings and reusable business signals for AI features through readable, testable aggregation pipeline stages."
category: "mongodb"
...
<ThemeCard title="What you will learn" badge="MONGODB HANDBOOK 04">
...
- [MongoDB Docs: Aggregation pipeline optimisation](https://www.mongodb.com/docs/manual/core/aggregation-pipeline-optimization/)
- [MongoDB PyMongo documentation](https://www.mongodb.com/docs/languages/python/pymongo-driver/current/)
