...
<KnowledgeCheck question={"What does RAG add before an AI model answers?"} options={["Relevant approved evidence retrieved for the question","A permanent memory of every user","Unrestricted internet access"]} answer={0} explanation={"RAG retrieves relevant source passages and supplies them as answer context."} />
