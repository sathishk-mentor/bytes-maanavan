...
summary: "Follow a user question through document preparation, retrieval, context assembly, grounded answer generation and traceable source citation."
...
<KnowledgeCheck question={"What is the main goal of a good document chunk?"} options={["Exact character count","One coherent idea with enough context to be useful","Removing every heading"]} answer={1} explanation={"Chunk boundaries should preserve meaning rather than optimise size alone."} />
