...
summary: "Apply risk-based review, secure coding checks, organisational policy controls and traceable audit evidence to AI-assisted software delivery."
...
<ThemeCard title="What you will learn" badge="GITHUB COPILOT HANDBOOK 05">
...
<KnowledgeCheck question={"What should happen when an AI tool proposes a new dependency?"} options={["Install it immediately","Review maintenance, licence, vulnerabilities and project policy","Disable dependency scanning"]} answer={1} explanation={"A useful package can still create security, legal and maintenance risk."} />
