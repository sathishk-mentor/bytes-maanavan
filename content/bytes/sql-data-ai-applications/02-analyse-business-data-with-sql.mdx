...
summary: "Summarise business data with SQL GROUP BY, then calculate ranks, running totals and meaningful comparisons with window functions without losing rows."
