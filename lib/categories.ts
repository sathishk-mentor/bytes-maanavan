...
export const CATEGORIES: Category[] = [
  ...
  { slug: 'forward-deployed-engineer', title: 'The Forward Deployed Engineer Handbook', description: 'Learn the FDE role, technical and commercial skillset, client engagement lifecycle, trust-building and career path.', icon: 'Workflow', color: 'violet', order: 7, heroLine: 'Bridge customer reality, engineering delivery and measurable outcomes' },
